...
export default function ContentTample3() {
        ...
        <div className="max-w-screen mx-auto px-6 md:px-20 py-10 md:py-20 border bg-white shadow-lg rounded-lg">
          <section>
            ...
            <div className="flex justify-center mt-6">
              <a
                href="https://cbtthailand.dasta.or.th/webapp/relattraction/content/2140/"
                target="_blank"
            ...
            >
              <div className="flex gap-2">
                {(Array.isArray(Datacontent[2].tagsdestinations)
                  ? Datacontent[2].tagsdestinations
                  : []
                ).map((tag) => (
                  <span
                    key={tag}
