...
export default function ContentTample2() {
        ...
        <div className="max-w-screen mx-auto px-6 md:px-20 py-10 md:py-20 border bg-white shadow-lg rounded-lg">
          <section>
            ...
            <div className="flex justify-center mt-6">
              <a
                href="https://www.facebook.com/share/p/1BcjLwATMh/"
                target="_blank"
            ...
            >
              <div className="flex gap-2">
                {(Array.isArray(Datacontent[1].tagsdestinations)
                  ? Datacontent[1].tagsdestinations
                  : []
                ).map((tag) => (
                  <span
                    key={tag}
            ...
            <div className="mt-6 bg-gray-100 shadow-lg p-6 rounded-lg max-w-5xl mx-auto">
              ...
              <div className="text-center mt-10">
                ...
                <div className="mt-4">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!4v1742383732728!6m8!1m7!1sYhhbvQ9WMeQw036enWiwWA!2m2!1d15.23806456732172!2d104.8649272860217!3f340.9917886469906!4f-0.6310301345253748!5f0.7820865974627469"
                    className="w-full h-80 md:h-120 rounded-lg shadow-md"
                    style={{ border: 0 }}
                    allowFullScreen
                    loading="lazy"
