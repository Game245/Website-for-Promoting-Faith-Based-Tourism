...
export default function ContentTample5() {
        ...
        <div className="max-w-screen mx-auto px-6 md:px-20 py-10 md:py-20 border bg-white shadow-lg rounded-lg">
          <section>
            ...
            <div className="flex justify-center mt-6">
              <a
                href="https://www.sanook.com/travel/1415505/gallery/2531489/"
                target="_blank"
            ...
            >
              <div className="flex gap-2">
                {(Array.isArray(Datacontent[4].tagsdestinations)
                  ? Datacontent[4].tagsdestinations
                  : []
                ).map((tag) => (
                  <span
                    key={tag}
            ...
            <div className="mt-6 bg-gray-100 shadow-lg p-6 rounded-lg max-w-5xl mx-auto">
              ...
              <div className="text-center mt-10">
                ...
                <div className="mt-4">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!4v1742388264179!6m8!1m7!1sCAoSF0NJSE0wb2dLRUlDQWdJQ2hoWWpUOFFF!2m2!1d15.30628696629427!2d105.1628163917705!3f296.49118784252164!4f-11.994232306492947!5f0.4000000000000002"
                    className="w-full h-80 md:h-120 rounded-lg shadow-md"
                    style={{ border: 0 }}
                    allowFullScreen
                    loading="lazy"
