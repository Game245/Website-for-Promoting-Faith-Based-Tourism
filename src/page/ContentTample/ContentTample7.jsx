...
export default function ContentTample7() {
  ...
  const displayedItems = [Datacontent[6].id];
  ...
  useEffect(() => {
    if (Datacontent.length > 6) {
      setContent(Datacontent[6]);
    }
  }, []);
        ...
        <div className="max-w-screen mx-auto px-6 md:px-20 py-10 md:py-20 border bg-white shadow-lg rounded-lg">
          <section>
            ...
            <div className="flex justify-center mt-6">
              ...
              >
                <img
                  src={Datacontent[6].img}
                  alt={Datacontent[6].title}
            ...
            >
              <div className="flex gap-2">
                {(Array.isArray(Datacontent[6].tagsdestinations)
                  ? Datacontent[6].tagsdestinations
                  : []
                ).map((tag) => (
                  <span
                    key={tag}
