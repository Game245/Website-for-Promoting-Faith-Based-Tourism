          ...
          <section>
            ...
            <div className="mt-6 bg-gray-100 shadow-lg p-6 rounded-lg max-w-5xl mx-auto">
              ...
              <div className="text-center mt-10">
                ...
                <div className="mt-4">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!4v1742389374885!6m8!1m7!1sCAoSFkNJSE0wb2dLRUlDQWdJRGM5ZmVyZFE.!2m2!1d15.22855999699148!2d104.8578760326625!3f176.60814605384383!4f6.649327075880862!5f0.7820865974627469"
                    className="w-full h-80 md:h-120 rounded-lg shadow-md"
                    style={{ border: 0 }}
                    allowFullScreen
                    loading="lazy"
