      ...
      <div className="container mx-auto  p-4  w-full">
        ...
        <div className="max-w-screen mx-auto px-6 md:px-20 py-10 md:py-20 border bg-white shadow-lg rounded-lg">
          <section>
              ...
              >
                <div className="bg-white p-6 rounded-lg shadow-lg max-w-md m-5">
                  ...
                  <ul className="mt-4 text-gray-700">
                    {activities[8].dedcriptionactivities.map((event, index) => (
            ...
            {showPopup === "amulet" && (
              ...
              >
                <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-sm md:max-w-lg  mt-10 max-h-screen overflow-y-auto relative">
                  {/* ปุ่มปิด */}
                  <FaTimes
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 w-full justify-items-center p-5">
                    {amuletData[8].image.map((imgSrc, index) => (
                      <img
                        key={index}
                        src={imgSrc}
                        alt={`${amuletData[8].name} - ${index + 1}`}
                  ...
                  <p className="text-gray-700 text-sm md:text-base mt-2">
                    {amuletData[8].description}
                  </p>
                  <p className="text-gray-900 font-bold text-sm md:text-base mt-2">
                    💰 ราคา: {amuletData[8].price}
                  </p>
                  <p className="text-gray-700 text-sm md:text-base mt-2">
                    🙏 วิธีบูชา: {amuletData[8].howToWorship}
                  </p>
                </div>
              </motion.div>
            )}
            ...
            >
              <div className="flex gap-2 items-center">
                {(Array.isArray(Datacontent[8].tagsrituals)
                  ? Datacontent[8].tagsrituals
                  : []
                ).map((tag) => (
                  <span
                    key={tag}
        ...
        <div className="mt-6 bg-gray-100 shadow-lg p-4 rounded-lg border-l-4 border-blue-500 max-w-5xl mx-auto">
          ...
          <p className="mt-2 text-gray-700 whitespace-pre-line">
            แหล่งที่มา :
            <a
              href="https://wimutti.org/%e0%b8%9a%e0%b8%97%e0%b8%aa%e0%b8%a7%e0%b8%94%e0%b8%a1%e0%b8%99%e0%b8%95%e0%b9%8c/%e0%b8%84%e0%b8%b3%e0%b9%81%e0%b8%9c%e0%b9%88%e0%b9%80%e0%b8%a1%e0%b8%95%e0%b8%95%e0%b8%b2/"
              target="_blank"
