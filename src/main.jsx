...
import ContentTample7 from "./page/ContentTample/ContentTample7.jsx";
import ContentTample8 from "./page/ContentTample/ContentTample8.jsx";
import ContentTample9 from "./page/ContentTample/ContentTample9.jsx";
...
import Rituals7 from "./page/Rituals/Rituals7.jsx";
import Rituals8 from "./page/Rituals/Rituals8.jsx";
import Rituals9 from "./page/Rituals/Rituals9.jsx";
...
import Myth7 from "./page/Myth/Myth7.jsx";
import Myth8 from "./page/Myth/Myth8.jsx";
import Myth9 from "./page/Myth/Myth9.jsx";
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "/contenttample7", element: <ContentTample7 /> },
      { path: "/contenttample8", element: <ContentTample8 /> },
      { path: "/contenttample9", element: <ContentTample9 /> },
      ...
      { path: "/rituals7", element: <Rituals7 /> },
      { path: "/rituals8", element: <Rituals8 /> },
      { path: "/rituals9", element: <Rituals9 /> },
      ...
      { path: "/myth7", element: <Myth7 /> },
      { path: "/myth8", element: <Myth8 /> },
      { path: "/myth9", element: <Myth9 /> },
